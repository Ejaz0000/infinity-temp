        ...
        <div className="fixed inset-0 bg-[rgba(0,0,0,0.25)] flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b flex items-center justify-between sticky top-0 bg-white" style={{ borderColor: 'var(--neutral-gray400)' }}>
              ...
              <button onClick={closeModal} className="p-1 hover:bg-gray-100 rounded-lg transition text-gray-600"><X className="w-6 h-6" /></button>
            </div>
            {detailsLoading ? (
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="p-3 rounded-lg" style={{ backgroundColor: 'rgba(0,0,0,0.02)' }}>
                    <p style={{ color: 'var(--neutral-gray700)' }}>{orderDetails?.customer_street}</p>
                    <p style={{ color: 'var(--neutral-gray700)' }}>{orderDetails?.customer_city}, {orderDetails?.customer_state} {orderDetails?.customer_postal_code}</p>
                    <p style={{ color: 'var(--neutral-gray700)' }}>{orderDetails?.customer_country}</p>
                  </div>
                </div>
