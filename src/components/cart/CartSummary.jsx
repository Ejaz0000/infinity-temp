  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 shadow-md p-8 sticky top-24 h-fit">
      ...
      <div className="flex items-center gap-3 mb-6">
        <ShoppingCart className="w-6 h-6" style={{ color: 'var(--accent-main)' }} />
      ...
      <div className="space-y-4 mb-6">
        ...
        {totalSavings > 0 && (
          <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
            <span className="text-blue-700 font-medium">Total Savings</span>
            <span className="font-semibold text-blue-700">-Tk. {totalSavings.toFixed(2)}</span>
          </div>
        )}
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center">
          ...
          <span className="text-3xl font-bold" style={{ color: 'var(--accent-main)' }}>
      ...
      <div className="space-y-3">
        <button onClick={() => router.push('/checkout')} className="w-full text-white font-bold py-3 px-4 rounded-lg transition-colors duration-200 text-lg hover:opacity-90" style={{ backgroundColor: 'var(--accent-main)' }}>
          Proceed to Checkout
        </button>
        <button
