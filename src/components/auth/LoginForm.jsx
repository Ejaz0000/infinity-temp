        ...
        <form onSubmit={handleForgotPassword} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition-all disabled:opacity-50"
          ...
          <div className="flex gap-3">
            ...
            <button
              type="submit"
              disabled={isSendingEmail}
              className="flex-1 text-white font-semibold py-2 px-4 rounded-lg transition-colors disabled:opacity-50 hover:opacity-90"
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          required
          disabled={isLoading}
          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          style={{ '--tw-ring-color': 'var(--accent-main)' }}
        />
        {errors.email && (
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            required
            disabled={isLoading}
            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition-all pr-12 disabled:opacity-50 disabled:cursor-not-allowed"
            style={{ '--tw-ring-color': 'var(--accent-main)' }}
          />
          <button
            type="button"
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="w-full text-white font-semibold py-2 px-4 rounded-lg transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-90"
        style={{ backgroundColor: 'var(--accent-main)' }}
      >
