...
const ProductsPage = ({
  ...
  const meta = initialProductsData?.meta ||
    initialProductsData?.pagination || {
      current_page: 1,
      last_page: 1,
      total: 0,
      per_page: 20,
      ...
      <div className="max-w-7xl mx-auto py-12">
        ...
        <div className="mb-12">
          {searchParams.get("search") ? (
            ...
            <h1 className="text-4xl font-semibold mb-2 text-orange-400">
              All Products
            </h1>
          )}
        ...
        <div className="flex items-center justify-between mb-8 gap-4">
          ...
          <button
            ...
            className="flex items-center text-gray-800 gap-2 px-4 py-2 rounded-lg border border-gray-400 hover:bg-gray-100 transition-colors"
          >
            <Filter size={20} />
            <span>Filters</span>
          </button>
          ...
          <select
            ...
            className="px-4 py-2 rounded-lg border bg-gray-100 border-gray-400 focus:outline-none focus:ring-2 ml-auto text-gray-800"
          >
